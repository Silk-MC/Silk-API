...
public final class ModelProvider extends FabricModelProvider {
	...
	public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
		...
		generator.registerFullCauldron(TextureMap.getSubId(Blocks.LAVA, "_still"), Blocks.CAULDRON, Blocks.LAVA_CAULDRON, Models.TEMPLATE_CAULDRON_FULL);
		try {
			generator.registerLeveledCauldron(TextureMap.getSubId(Blocks.WATER, "_still"), Blocks.CAULDRON, (LeveledCauldronLikeBlock) Blocks.WATER_CAULDRON, Models.TEMPLATE_CAULDRON_LEVEL1, Models.TEMPLATE_CAULDRON_LEVEL2, Models.TEMPLATE_CAULDRON_FULL);
		} catch (Exception e) {
		}
	}
