...
public final class DataGen implements DataGenerator {
	...
	public void generate(FabricDataGenerator.Pack builtinPack, Optional<FabricDataGenerator.Pack> dataPack, Optional<FabricDataGenerator.Pack> resourcePack) {
		builtinPack.addProvider(I18nProvider.EN_US::provider);
		builtinPack.addProvider(I18nProvider.ZH_CN::provider);
		builtinPack.addProvider(I18nProvider.ZH_HK::provider);
		builtinPack.addProvider(I18nProvider.ZH_TW::provider);
	}
