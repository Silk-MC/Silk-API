...
/**
 * <h2 style="color:FFC800">配方序列化器</h2>
 * 用于补充原版的配方序列化器以便在模组中使用
 *
...
public interface RecipeSerializer extends RecipeSerializerRegistry {
	 ...
	 * 带 NBT 的有序配方序列化器
	 */
	NbtShapedRecipe.Serializer NBT_SHAPED = RecipeSerializerRegistry.registrar(new NbtShapedRecipe.Serializer()).register(SilkApi.getInternal(), "crafting_nbt_shaped");
}
