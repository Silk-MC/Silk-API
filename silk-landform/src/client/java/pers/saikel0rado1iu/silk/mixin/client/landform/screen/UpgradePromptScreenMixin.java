...
import pers.saikel0rado1iu.silk.api.client.landform.screen.UpgradePromptScreen;

import java.io.IOException;
import java.util.Objects;

import static pers.saikel0rado1iu.silk.api.client.landform.screen.UpgradePromptScreen.*;
