...
public final class ModPlusDataGen implements DataGenerator {
	...
	public void generate(FabricDataGenerator.Pack builtinPack, Optional<FabricDataGenerator.Pack> dataPack, Optional<FabricDataGenerator.Pack> resourcePack) {
		builtinPack.addProvider(ModPlusI18nProvider.EN_US::provider);
		builtinPack.addProvider(ModPlusI18nProvider.ZH_CN::provider);
		builtinPack.addProvider(ModPlusI18nProvider.ZH_HK::provider);
		builtinPack.addProvider(ModPlusI18nProvider.ZH_TW::provider);
	}
