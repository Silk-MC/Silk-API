...
import pers.saikel0rado1iu.silk.ropestick.ranged.BoltActionRepeatingFirearm;
...
/**
 * Test {@link BoltActionRepeatingFirearm}
 */
public final class BoltActionRepeatingFirearmTest extends BoltActionRepeatingFirearm {
	/**
	 * @param settings 物品设置
	 */
	public BoltActionRepeatingFirearmTest(Settings settings) {
		super(settings);
	}
