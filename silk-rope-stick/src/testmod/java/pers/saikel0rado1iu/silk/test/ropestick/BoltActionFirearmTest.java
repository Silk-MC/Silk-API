...
import pers.saikel0rado1iu.silk.ropestick.ranged.BoltActionFirearm;
...
/**
 * Test {@link BoltActionFirearm}
 */
public final class BoltActionFirearmTest extends BoltActionFirearm {
	/**
	 * @param settings 物品设置
	 */
	public BoltActionFirearmTest(Settings settings) {
		super(settings);
	}
