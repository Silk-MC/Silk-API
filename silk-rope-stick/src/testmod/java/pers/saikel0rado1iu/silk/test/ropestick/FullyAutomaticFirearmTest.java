...
import pers.saikel0rado1iu.silk.api.ropestick.ranged.FullyAutomaticFirearm;
...
/**
 * Test {@link FullyAutomaticFirearm}
 */
public final class FullyAutomaticFirearmTest extends FullyAutomaticFirearm {
	/**
	 * @param settings 物品设置
	 */
	public FullyAutomaticFirearmTest(Settings settings) {
		super(settings);
	}
