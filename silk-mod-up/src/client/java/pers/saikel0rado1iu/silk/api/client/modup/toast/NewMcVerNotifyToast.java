...
/**
 * <h2 style="color:FFC800">新 MC 版本模组提示框</h2>
 * 新 MC 版本模组更新提示
 *
...
public class NewMcVerNotifyToast extends UpdateToast {
	 ...
	 */
	public NewMcVerNotifyToast(UpdateData updateData, ClientUpdateManager updateManager) {
		super(Text.translatable(UpdateState.NEW_MC_VER.title(), updateData.modData().i18nName(), updateData.minecraftVersion()),
				updateData, updateManager,
				Text.translatable(UpdateState.NEW_MC_VER.text(), updateData.modData().i18nName(), updateData.minecraftVersion()));
	}
}
