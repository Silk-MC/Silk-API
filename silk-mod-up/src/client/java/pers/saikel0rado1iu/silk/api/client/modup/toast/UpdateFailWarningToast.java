...
/**
 * <h2 style="color:FFC800">更新失效警告提示框</h2>
 * 更新系统失效警告提示
 *
...
public class UpdateFailWarningToast extends UpdateToast {
	 ...
	 */
	public UpdateFailWarningToast(UpdateData updateData, ClientUpdateManager updateManager) {
		super(Text.translatable(UpdateState.UPDATE_FAIL.title()), updateData, updateManager, Text.translatable(UpdateState.UPDATE_FAIL.text()));
	}
}
