...
/**
 * <h2 style="color:FFC800">此 MC 版本模组更新屏幕</h2>
 * 此 MC 版本模组更新提示界面
 *
...
public class ThisMcVerNotifyScreen extends UpdateScreen {
	 ...
	 */
	public ThisMcVerNotifyScreen(Optional<Screen> parent, UpdateData updateData, ClientUpdateManager updateManager, boolean canTrust) {
		super(parent, updateData, updateManager, Text.translatable(UpdateState.THIS_MC_VER.title(), updateData.modData().i18nName(), updateData.modVersion()));
	...
	protected void initWidgets(GridWidget gridWidget) {
		...
		MultilineTextWidget messageText = new MultilineTextWidget(0, 0,
				Text.translatable(UpdateState.THIS_MC_VER.text(), updateData.modData().i18nName(), updateData.modVersion()), textRenderer)
