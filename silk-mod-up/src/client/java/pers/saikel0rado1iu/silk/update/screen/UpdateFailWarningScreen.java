...
/**
 * <h2 style="color:FFC800">更新失效警告屏幕</h2>
 * 更新系统失效警告界面
 *
...
public class UpdateFailWarningScreen extends UpdateScreen {
	 ...
	 */
	public UpdateFailWarningScreen(Optional<Screen> parent, UpdateData updateData, ClientUpdateManager updateManager, boolean canTrust) {
		super(parent, updateData, updateManager, Text.translatable(UpdateState.UPDATE_FAIL.title()));
	...
	protected void initWidgets(GridWidget gridWidget) {
		...
		MultilineTextWidget messageText = new MultilineTextWidget(0, 0,
				Text.translatable(UpdateState.UPDATE_FAIL.text()), textRenderer)
