...
public class UpdateFailWarningScreen extends UpdateScreen {
	 ...
	 * 构造更新屏幕类
	 */
	public UpdateFailWarningScreen(Screen parent, UpdateData data, boolean canTrust) {
		super(parent, data, Text.translatable(ScreenUtil.widgetText(data.getMod(), "update_fail_warning"))
	...
	protected void init() {
		...
		super.init();
		// 添加提示消息文本
		messageText = MultilineText.create(textRenderer, Text.translatable(ScreenUtil.widgetText(data.getMod(), "update_fail_warning"))
