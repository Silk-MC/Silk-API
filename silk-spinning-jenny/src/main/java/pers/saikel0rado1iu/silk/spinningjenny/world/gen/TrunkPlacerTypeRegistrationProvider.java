...
interface TrunkPlacerTypeRegistrationProvider extends MainRegistrationProvider<TrunkPlacerType<?>> {
	String SERVER_REGISTRAR = "pers.saikel0rado1iu.silk.spinningjenny.world.gen.TrunkPlacerTypeRegistrationProvider.MainRegistrar";
	...
	final class MainRegistrar<T extends TrunkPlacerType<?>> extends Registrar<T, MainRegistrar<T>> {
		...
		public T register(ModPass modPass, String id) {
			Registry.register(Registries.TRUNK_PLACER_TYPE, modPass.modData().ofId(id), type);
